...
export const ProfileToBasketball = () => {
  const [gameState, setGameState] = useState('profile'); // profile, transforming, game
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative">
        ...
        <div 
          ref={mountRef} 
          className="w-96 h-64 relative cursor-pointer"
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            ...
            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-center">
              <div className="bg-primary/80 text-white px-4 py-2 rounded-lg">
                Click to transform into basketball! 🏀
              </div>
            </div>
          </div>
        )}
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-4 pointer-events-none">
            ...
            <div className="text-center">
              {gameState === 'transforming' && (
                <div className="bg-yellow-500/80 text-white px-4 py-2 rounded-lg animate-pulse">
                  🏀 Transforming into basketball! 🏀
                </div>
              )}
              {gameState === 'aiming' && (
      ...
      <div className="mt-4 text-center text-sm text-muted-foreground">
        {gameState === 'profile' && (
          <p>Your profile picture will transform into a basketball for shooting!</p>
        )}
        {gameState === 'aiming' && (
